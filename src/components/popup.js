...
class PopUp extends React.Component {
    ...
    render() {
        ...
        if (!status.main) return <View />

        return (
            <Gradient {...gradient(status.main, status.border, [styles.container, this._get_scale()])}>
                <View style={styles.title_parent}>
                    <Text style={[styles.title, { color: status.main }]}>{status.title}</Text>
                </View>
